...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo "index.php?page=jualan&id=".$_GET['id']."&kategori=".$_GET['kategori']; ?>"><?php echo $_GET['kategori']; ?></a></li>
</ol>
<?php } ?>
		...
		<tbody>
			<?php 
				...
				<tr>
					...
					<td>
						<strong><a href="<?php echo "index.php?page=detail&id=".$_GET['id']."&jl=".$index_jual->id_jual."&mm=".$index_jual->id_member; ?>"><?php echo $index_jual->nama_barang; ?></a></strong>
