...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo "index.php?page=regional&id=".$_GET['id']; ?>"><?php echo $index_jual->regional; ?></a></li>
  <li><a href="<?php echo "index.php?page=jualan&id=".$_GET['id']."&kategori=".$index_jual->kategori_jual."&reg=".$index_jual->regional; ?>"><?php echo $index_jual->kategori_jual; ?></a></li>
 		...
 		<div class="panel-body">
 			<table class="table">
 				<tr>
 					...
 					<td>
 						<a href="<?php echo "index.php?page=detail&id=".$_GET['id']."&jl=".$index_area->id_jual."&mm=".$index_area->id_member; ?>"><?php echo $index_area->nama_barang; ?></a>
 						<br>
